...
export function CategoryTabs({ active, onChange }: Props) {
  return (
    <div className="-mx-4 no-scrollbar overflow-x-auto py-1.5 snap-x snap-mandatory scroll-pl-4">
      <div className="flex w-max items-center gap-2 pl-4 pr-4" role="tablist">
